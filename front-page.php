...
<main id="smartshop-main" class="smartshop-main smartshop-home" role="main">
	...
	<!-- ═══════════════════════════════════
	     HERO BANNER
	═══════════════════════════════════ -->
	<?php get_template_part( 'template-parts/woocommerce/hero-banner' ); ?>
	...
	<section class="smartshop-trust" aria-label="<?php esc_attr_e( 'Why shop with us', 'smartshop' ); ?>">
		<div class="container">
			<?php get_template_part( 'template-parts/woocommerce/trust-badges' ); ?>
		</div>
	</section>
	...
	<!-- ═══════════════════════════════════
	     PROMO SPLIT BANNER
	═══════════════════════════════════ -->
	<?php get_template_part( 'template-parts/woocommerce/promo-split' ); ?>
	...
	<!-- ═══════════════════════════════════
	     TESTIMONIALS
	═══════════════════════════════════ -->
	<?php get_template_part( 'template-parts/woocommerce/testimonials' ); ?>
